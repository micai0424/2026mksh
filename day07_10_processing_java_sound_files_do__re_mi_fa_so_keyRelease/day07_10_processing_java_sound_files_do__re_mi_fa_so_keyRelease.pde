//day07_10_processing_java_sound_files_do _re_mi_fa_so_keyReleased
// 修改自 day07_9_processing_java_sound_files_do_re_mi_fa_so
import processing.sound.*; // 使用 Processsing 的 Sound 外掛
SoundFile sound1, sound2, sound3, sound4, sound5; // 拉進5個音檔
void setup(){  //設定函數
  size(500,100);
...
void keyPressed(){  //按下鍵盤的1, 2, 3, 4, 5 可發出聲音
  if(key=='1'){ a[0]=1;sound1.play();} // 小心切換輸入法(記得是英文輸入)
